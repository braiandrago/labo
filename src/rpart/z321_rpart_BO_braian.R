...
ksemilla_azar  <- 931811   #cambiar por la primer semilla
...
setwd("C:/Users/bddra/Desktop/MAESTRIA _DS/Labdeimp_I/labo/exp/HT3210/")   #Establezco el Working Directory DEL EXPERIMENTO
