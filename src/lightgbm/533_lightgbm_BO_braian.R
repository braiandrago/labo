...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower=  0.02 , upper=    0.04),
  makeNumericParam("feature_fraction", lower=  0.4  , upper=    0.5),
  makeIntegerParam("min_data_in_leaf", lower=  2000    , upper= 3000),
  makeIntegerParam("num_leaves",       lower= 6L   , upper= 31L),
  makeIntegerParam("lambda_l1",       lower= 0L   , upper= 30L),
  makeIntegerParam("lambda_l2",         lower= 0.0, upper= 30L),
  makeNumericParam("prob_corte",       lower= 1/120 , upper=  1/20)  #esto sera visto en clase en gran detalle
)


ksemilla_azar  <- 931811  #Aqui poner la propia semilla
...
setwd("C:/Users/bddra/Desktop/MAESTRIA _DS/Labdeimp_I/labo/exp/HT5330/")   #Establezco el Working Directory DEL EXPERIMENTO
