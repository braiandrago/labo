...
##Creado para Probar nuevas variables (Ejercicio 6 - Tarea Hogar 2)
##Utiliza el dataset extendido que surge de el script 402_FE_Simple
## Para una primer corrida se dejan los hiperparametros del script 533BO original
##SE CAMBIA LA CLASE A BINARIA (Se entrena  con  POS = { BAJA+1, BAJA+2 })
