...
#MODIFICACION DE BRAIAN DRAGO PARA PRUEBA DE CLUSTERS CON VARIABLES NUEVAS
#QUE HAYAN RESULTADO IMPORTANTES PARA EL MODELO
#PARTICULARMENTE SE TOMAN VARIABLES DEL FE8133
...
#cluster jerÃ¡rquico  utilizando "la distancia de Random Forest"
#adios a las fantasias de k-means y las distancias mÃ©tricas, cuanto tiempo perdido ...
...
dataset  <- fread( "./exp/FE8133/paquete_premium_ext.csv.gz", stringsAsFactors= TRUE)
...
campos_buenos  <- c( "ctrx_quarter", "liquid_tot","acred_comis","mdescubierto_preacordado","cpayroll_trx", "mcaja_ahorro", "mtarjeta_visa_consumo", "ctarjeta_visa_trx",
...
dir.create( "./exp/ST8888", showWarnings= FALSE )
setwd( "~/buckets/b1/exp/ST8888" )
